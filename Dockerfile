...
FROM registry.access.redhat.com/ubi9/ubi-minimal@sha256:850143255ee0d1915f09aaa09f6ed31f24086ba605c323badfbefa95b8c52b0e AS build
...
ENV RAILS_ENV=production RAILS_LOG_TO_STDOUT=true HOME=/opt/app-root/src DEV_DEPS=$devDeps prometheus_multiproc_dir=/opt/app-root/src/tmp prometheus_rust_mmaped_file=false \
    BUNDLE_PATH="./.bundle" BUNDLE_WITHOUT="development:test" BUNDLE_DEPLOYMENT="true" BUNDLE_FORCE_RUBY_PLATFORM="true"

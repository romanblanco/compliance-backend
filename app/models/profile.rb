...
class Profile < ApplicationRecord
  ...
  has_many :profile_rules, class_name: 'ProfileRule', dependent: :destroy
  has_many :rules, through: :profile_rules, class_name: 'Rule'
  has_many :os_minor_versions, class_name: 'ProfileOsMinorVersion', dependent: :destroy

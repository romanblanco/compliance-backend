      ...
      context 'with never reported systems' do
        ...
        let(:item) do
          FactoryBot.create(
            ...
            PolicySystem.create!(policy: report.policy, system: system_with_result)
            PolicySystem.create!(policy: report.policy, system: system_without_result)
      ...
      context 'with system reporting to different reports' do
        ...
        let(:item) do
          FactoryBot.create(
            ...
            PolicySystem.create!(policy: report.policy, system: system)
            PolicySystem.create!(policy: other_report.policy, system: system)

...
describe 'Systems', swagger_doc: 'v2/openapi.json' do
  ...
  path '/systems' do
    ...
    get 'Request Systems' do
      ...
      search_params_v2(System, except: %i[never_reported os_version])
  ...
  path '/policies/{policy_id}/systems' do
    ...
    get 'Request Systems assigned to a Policy' do
      ...
      pagination_params_v2
      ids_only_param
      sort_params_v2(System, except: %i[os_major_version])
      search_params_v2(
        System, except: %i[os_version never_reported os_major_version policies profile_ref_id assigned_or_scanned]
      )
  ...
  path '/reports/{report_id}/systems' do
    ...
    get 'Request Systems assigned to a Report' do
      ...
      ids_only_param
      sort_params_v2(System, except: %i[os_major_version])
      search_params_v2(System, except: %i[os_version os_major_version policies profile_ref_id assigned_or_scanned])
